...
{
    public class SetLightingSchedule : Device
    {
        ...
        private int nodeID;
        public SetLightingSchedule(MQTTnet.ClientLib.MqttService mqttService, int systemID, int basestationID, int nodeID) : base(mqttService, systemID, basestationID)
        {
            this.nodeID = nodeID;
        }
